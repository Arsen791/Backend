...
class User_info(models.Model):
    ...
    year_of_graduation = models.FloatField(null=False, default=False)
...
class User_work(models.Model):
    ...
    experience = models.FloatField(null=False, default=False)
...
class Medical(models.Model):
    medical_examination = models.FileField
